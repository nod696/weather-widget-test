<template>
  <section class="widget__container">
    ...
    <WeatherConfiguration v-if="weatherItems" @changeData="changeDataCities" :cities="weatherItems" :isClosed="isClosed"></WeatherConfiguration>
